                ...
                <a href="/special/102822/view?&amp;utag=ref_tpl:111942$ref_cnr:23360$set:2$dpos:1" onclick="cnrClickLoging('23360','세트 2','1','/special/102822/view');">
                    <div className="gods-img">
                        ...
                        <div className="gods-desc">
                            <p className="tit">HAPPY NEW SEASON<br/>2매 이상 구매 시 추가 10%</p>
                ...
                <div className="gods-item" view-godno="GM0024102903194">
                    <a href="javascript:goToProductDetailCorner('BEANPOLE-KIDS', 'GM0024102903194', '', 'ourPickOURPICK_AType23360',1,'23360','세트 1');">
                        ...
                        <div className="gods-info">
                            ...
                            <p className="price">
                                <del>
                                    <span className="wa_hidden">원가</span>
                                    209,000<span className="wa_hidden">원</span>
                                </del>
                                <em className="sale"><span className="wa_hidden">할인율</span>
                                    10%
                                </em>
                                <span className="wa_hidden">판매가</span>
                                188,100<span className="wa_hidden">원</span>
                            </p>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="javascript:goToProductDetailCorner('BEANPOLE-KIDS', 'GM0024102903196', '', 'ourPickOURPICK_AType23360',2,'23360','세트 1');">
                        ...
                        <div className="gods-info">
                            ...
                            <p className="price">
                                ...
                                <em className="sale">
                                    <span className="wa_hidden">할인율</span>10%
                                </em>
                                <span className="wa_hidden">판매가</span>188,100<span className="wa_hidden">원</span>
                            </p>
                        </div>
                    </a>
                </div>
            ...
            <div className="gods-main">
                <a href="/special/103471/view?&amp;utag=ref_tpl:111942$ref_cnr:23360$set:2$dpos:1" onclick="cnrClickLoging('23360','세트 4','1','/special/103471/view');">
                    <div className="gods-img">
                        ...
                        <div className="gods-desc">
                            <p className="tit">사은품으로 더하는 쇼핑의 즐거움<br/>인기 쿡웨어부터 조리도구까지</p> <p className="desc">WAGENSTEIGER</p>
                        </div>
                    </div>
                </a>
            </div>
                    ...
                    <a href="javascript:goToProductDetailCorner('WAGENSTEIGER', 'GQW924042940175', '', 'ourPickOURPICK_AType23360',1,'23360','세트 4');">
                        ...
                        <div className="gods-info">
                            ...
                            <p className="price">
                                <del>
                                    <span className="wa_hidden">원가</span>
                                    52,900<span className="wa_hidden">원</span>
                                </del>
                                <em className="sale">
                                    <span className="wa_hidden">할인율</span>52%
                                </em>
                                <span className="wa_hidden">판매가</span>25,330<span className="wa_hidden">원</span>
                            </p>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="javascript:goToProductDetailCorner('WAGENSTEIGER', 'GQW923081672649', '', 'ourPickOURPICK_AType23360',2,'23360','세트 4');">
                        ...
                        <div className="gods-info">
                            ...
                            <p className="price">
                                <del>
                                    <span className="wa_hidden">원가</span>
                                    33,500<span className="wa_hidden">원</span>
                                </del>
                                <em className="sale">
                                    <span className="wa_hidden">할인율</span>43%
                                </em>
                                <span className="wa_hidden">판매가</span>
                                19,220<span className="wa_hidden">원</span>
                            </p>
                        </div>
                    </a>
                </div>
            ...
            <div className="gods-main">
                <a href="/special/103411/view?&amp;utag=ref_tpl:111942$ref_cnr:23360$set:2$dpos:1" onclick="cnrClickLoging('23360','세트 3','1','/special/103411/view');">
                    <div className="gods-img">
                        ...
                        <div className="gods-desc">
                            <p className="tit">일상 그리고 나를 위한 선택<br/>이월 특가 + 15% 쿠폰</p>
                            <p className="desc">K2 &amp; EIDER</p>
                        </div>
                    </div>
                </a>
            </div>
                    ...
                    <a href="javascript:goToProductDetailCorner('EIDER', 'GQ0EA24082832355', '', 'ourPickOURPICK_AType23360',1,'23360','세트 3');">
                        ...
                        <div className="gods-info">
                            ...
                            <p className="price">
                                <del>
                                    <span className="wa_hidden">원가</span>
                                    245,000<span className="wa_hidden">원</span>
                                </del>
                                <em className="sale">
                                    <span className="wa_hidden">할인율</span>39%
                                </em>
                                <span className="wa_hidden">판매가</span>149,000<span className="wa_hidden">원</span>
                            </p>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="javascript:goToProductDetailCorner('K2', 'GQ0EA24082832363', '', 'ourPickOURPICK_AType23360',2,'23360','세트 3');">
                        ...
                        <div className="gods-info">
                            ...
                            <p className="price">
                                <del>
                                    <span className="wa_hidden">원가</span>
                                    382,000<span className="wa_hidden">원</span>
                                </del>
                                <em className="sale">
                                    <span className="wa_hidden">할인율</span>57%
                                </em>
                                <span className="wa_hidden">판매가</span>165,450<span className="wa_hidden">원</span>
                            </p>
                        </div>
                    </a>
                </div>
            ...
            <div className="gods-main">
                <a href="/special/103149/view?&amp;utag=ref_tpl:111942$ref_cnr:23360$set:2$dpos:1" onclick="cnrClickLoging('23360','세트 5','1','/special/103149/view');">
                    <div className="gods-img">
                        ...
                        <div className="gods-desc">
                            <p className="tit">혜택으로 채우는 풍요로운 설<br/>연휴 한정 13, 18% 더블 쿠폰</p>
                            <p className="desc">ANOTHER#</p>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <div className="gods-item" view-godno="GQKZ24052598667">
                    <a href="javascript:goToProductDetailCorner('HAI', 'GQKZ24052598667', '', 'ourPickOURPICK_AType23360',1,'23360','세트 5');">
                        ...
                        <div className="gods-info">
                            ...
                            <p className="price">
                                <del>
                                    <span className="wa_hidden">원가</span>148,000<span className="wa_hidden">원</span>
                                </del>
                                <em className="sale">
                                    <span className="wa_hidden">할인율</span>30%
                                </em>
                                <span className="wa_hidden">판매가</span>103,600<span className="wa_hidden">원</span>
                            </p>
                        </div>
                    </a>
                </div>
                <div className="gods-item" view-godno="GQ5924121824966">
                    <a href="javascript:goToProductDetailCorner('Victoria', 'GQ5924121824966', '', 'ourPickOURPICK_AType23360',2,'23360','세트 5');">
                        ...
                        <div className="gods-info">
                            ...
                            <p className="price">
                                <del>
                                    <span className="wa_hidden">원가</span>79,000<span className="wa_hidden">원</span>
                                </del>
                                <em className="sale">
                                    <span className="wa_hidden">할인율</span>30%
                                </em>
                                <span className="wa_hidden">판매가</span>55,300<span className="wa_hidden">원</span>
                            </p>
                        </div>
                    </a>
                </div>
            ...
            <div className="gods-main">
                <a href="/special/103025/view?&amp;utag=ref_tpl:111942$ref_cnr:23360$set:2$dpos:1" onclick="cnrClickLoging('23360','세트 6','1','/special/103025/view');">
                    <div className="gods-img">
                        ...
                        <div className="gods-desc">
                            <p className="tit">무궁한 사랑<br/>태극당과 비이커의 달콤한 만남</p>
                            <p className="desc">BEAKER</p>
                        </div>
                    </div>
                </a>
            </div>
                            ...
                            <a href="javascript:goToProductDetailCorner('BEAKER-X-TAEGEUKDANG', 'GM0025011482333', '', 'ourPickOURPICK_AType23360',1,'23360','세트 6');">
                                ...
                                <div className="gods-info">
                                    ...
                                    <p className="price">
                                        <del>
                                            <span className="wa_hidden">원가</span>
                                            35,000<span className="wa_hidden">원</span>
                                        </del>
                                        <em className="sale">
                                            <span className="wa_hidden">할인율</span>5%
                                        </em>
                                        <span className="wa_hidden">판매가</span>33,250<span className="wa_hidden">원</span>
                                    </p>
                                </div>
                            </a>
                        </div>
                    ...
                    <a href="javascript:goToProductDetailCorner('BEAKER-X-TAEGEUKDANG', 'GM0025011482289', '', 'ourPickOURPICK_AType23360',2,'23360','세트 6');">
                        ...
                        <div className="gods-info">
                            ...
                            <p className="price">
                                <del>
                                    <span className="wa_hidden">원가</span>
                                    34,000<span className="wa_hidden">원</span>
                                </del>
                                <em className="sale">
                                    <span className="wa_hidden">할인율</span>5%
                                </em>
                                <span className="wa_hidden">판매가</span>32,300<span className="wa_hidden">원</span>
                            </p>
                        </div>
                    </a>
                </div>
            ...
            <div className="gods-main">
                <a href="/special/103543/view?&amp;utag=ref_tpl:111942$ref_cnr:23360$set:2$dpos:1" onclick="cnrClickLoging('23360','세트 8','1','/special/103543/view');">
                    <div className="gods-img">
                        ...
                        <div className="gods-desc">
                            <p className="tit">일상 속 향기로운 휴식<br/>단독 최저가 + 10% 쿠폰</p>
                            <p className="desc">HUXLEY</p>
                        </div>
                    </div>
                </a>
            </div>
                    ...
                    <a href="javascript:goToProductDetailCorner('Huxley', 'GQCZ24080272205', '', 'ourPickOURPICK_AType23360',1,'23360','세트 8');">
                        ...
                        <div className="gods-info">
                            ...
                            <p className="price">
                                <del>
                                    <span className="wa_hidden">원가</span>
                                    28,000<span className="wa_hidden">원</span>
                                </del>
                                <em className="sale">
                                    <span className="wa_hidden">할인율</span>36%
                                </em>
                                <span className="wa_hidden">판매가</span>18,060<span className="wa_hidden">원</span>
                            </p>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="javascript:goToProductDetailCorner('Huxley', 'GQCZ24071425308', '', 'ourPickOURPICK_AType23360',2,'23360','세트 8');">
                        ...
                        <div className="gods-info">
                            ...
                            <p className="price">
                                <del>
                                    <span className="wa_hidden">원가</span>
                                    38,000<span className="wa_hidden">원</span>
                                </del>
                                <em className="sale">
                                    <span className="wa_hidden">할인율</span>27%
                                </em>
                                <span className="wa_hidden">판매가</span>27,630<span className="wa_hidden">원</span>
                            </p>
                        </div>
                    </a>
                </div>
            ...
            <div className="gods-main">
                <a href="/special/103195/view?&amp;utag=ref_tpl:111942$ref_cnr:23360$set:2$dpos:1" onclick="cnrClickLoging('23360','세트 7','1','/special/103195/view');">
                    <div className="gods-img">
                        ...
                        <div className="gods-desc">
                            <p className="tit">황금연휴에 더 큰 혜택으로<br/>우리집 살림 장만 ~72%</p>
                            <p className="desc">LIFE</p>
                        </div>
                    </div>
                </a>
            </div>  
                    ...
                    <a href="javascript:goToProductDetailCorner('STAUB', 'GQ9N24022819215', '', 'ourPickOURPICK_AType23360',1,'23360','세트 7');">
                        ...
                        <div className="gods-info">
                            ...
                            <p className="price">
                                <del>
                                    <span className="wa_hidden">원가</span>
                                    54,000<span className="wa_hidden">원</span>
                                </del>
                                <em className="sale">
                                    <span className="wa_hidden">할인율</span>57%
                                </em>
                                <span className="wa_hidden">판매가</span>23,000<span className="wa_hidden">원</span>
                            </p>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="javascript:goToProductDetailCorner('CORELLE', 'GQ9N21122854068', '', 'ourPickOURPICK_AType23360',2,'23360','세트 7');">
                        ...
                        <div className="gods-info">
                            ...
                            <p className="price">
                                <del>
                                    <span className="wa_hidden">원가</span>
                                    98,700<span className="wa_hidden">원</span>
                                </del>
                                <em className="sale">
                                    <span className="wa_hidden">할인율</span>31%
                                </em>
                                <span className="wa_hidden">판매가</span>68,000<span className="wa_hidden">원</span>
                            </p>
                        </div>
                    </a>
                </div>
