...
export default function MypageReturn() {
        ...
        <div className='order-list-ordertab'>
            ...
            {open &&
                <div className='order-list-delivery'>
                    <div className='order-list-returndots'></div>
                    ...
                    <div className='order-list-deliverylist'>
                        <ul>
                            <li>
                                <span>1</span>
                                <span>반품 신청</span>                                
                                <span>배송완료 후 7일 이내 신청 가능합니다. 사유에 따라 반품배송비가 부과될 수 있습니다. 반품비 추가 결제가 필요한 경우, 결제단계까지 완료되어야 신청됩니다.</span>
                            </li>
                            <li>
                                <span>2</span>
                                <span>반품 접수</span>
                            ...
                            <li>
                                ...
                                <span>회수상품 확인중</span>                                
                                <span>
                                회수상품 검수를 통해 반품가능 여부를 확인합니다. 신청 사유와 상이하거나 상품에 이상이 있는 경우 반품 처리가 되지 않을 수 있습니다.</span>
                            </li>
                            <li>
                                <span>6</span>
                                <span>환불</span>                               
                                <span>검수가 완료되어 결제금액이 환불됩니다.</span>                                
                            </li>
                        </ul>
                    </div>
                </div>
