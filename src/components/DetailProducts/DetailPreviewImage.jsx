...
export default function DetailPreviewImage() {
        ...
        <div className="preview-img"> {/* 전체 미리보기 컨테이너 */}
            ...
            >
                ...
                <div className="img-item active">
                    <img 
                        src="https://img.ssfshop.com/cmd/LB_750x1000/src/https://img.ssfshop.com/goods/ORBR/24/10/14/GPDN24101477500_0_THNAIL_ORGINL_20241023161548815.jpg"
                    />
                </div>
            </div>
            ...
            <div 
                ...
                style={{
                    backgroundImage: `url("https://img.ssfshop.com/goods/ORBR/24/10/14/GPDN24101477500_0_THNAIL_ORGINL_20241023161548815.jpg")`, // 확대될 배경 이미지 설정
